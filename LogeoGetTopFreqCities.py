...
import pandas as pd
from LogeoFuncs import get_query_id, ids_fs_to_bow, get_query_fq #, tokens_f, preprocess, strip_accents, get_sim_cns, get_query_sim_scores, get_top_w2v,bow_from_freqs, , stopwords, get_top_tfidf, get_top_bow
path = 'ling_assets/'
